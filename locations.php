    ...
    <table class="table table-bordered">
        ...
        <?php foreach ($rows as $r): ?>
            <tr>
                ...
                <td>
                    <a href="locations.php?id=<?=$r['id']?>" class="btn btn-sm btn-info">Edit</a>
                    <a href="locations.php?delete=<?=$r['id']?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this location?')">Delete</a>
                </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
