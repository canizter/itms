...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
  ...
  <h2 class="text-xl font-bold tracking-tight text-gray-900">Consumable Types</h2>
    ...
    <div class="bg-white rounded-lg shadow-lg w-full max-w-md mx-auto">
      <form method="post">
        <div class="flex items-center justify-between px-6 py-4 border-b">
          ...
          <button type="button" class="text-gray-400 hover:text-gray-700 text-xl font-bold" onclick="document.getElementById('addTypeModal').classList.add('hidden')">&times;</button>
        </div>
        <div class="px-6 py-4">
          <div class="mb-4">
